        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mr-2 text-blue-500" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path
                        d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 01-2 2h-2a2 2 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 012 2v2a2 2 01-2 2h-2a2 2 01-2-2v-2z" />
                </svg>
                Departamentos
            </h1>
