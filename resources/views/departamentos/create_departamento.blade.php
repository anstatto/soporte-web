...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <form action="{{ route('departamentos.store') }}" method="POST" class="px-6 py-4">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('departamentos.index') }}" class="text-blue-500 hover:text-blue-600 font-bold transition duration-300 ease-in-out">Cancelar</a>
            </div>
        </form>
    </div>
</div>
