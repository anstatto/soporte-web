            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <ul class="space-y-2">
                    ...
                    <li class="flex justify-between items-center">
                        ...
                        <span class="font-semibold">{{ App\Models\Ticket::where('estado_id', 2)->count() }}</span>
                    </li>
                    <li class="flex justify-between items-center">
                    ...
                    <li class="flex justify-between items-center">
                        <span class="text-gray-600">Tickets Recividos:</span>
                ...
                @foreach (App\Models\Ticket::latest()->take(5)->get() as $ticket)
                    <li class="border-b pb-2">
                        ...
                        <a href="{{ route('tickets.show', $ticket) }}"
                            class="text-blue-600 hover:underline">{{ $ticket->titulo }}</a>
                    </li>
                @endforeach
            </ul>
        </div>
