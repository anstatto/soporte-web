...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-4xl font-bold mb-8 text-gray-800">Lista de Tickets</h1>
        ...
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full" style="background-color: {{ $ticket->estado->color }}; color: {{ $getContrastColor($ticket->estado->color) }};">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <form action="{{ route('tickets.destroy', $ticket) }}" method="POST" class="inline-block">
                                ...
                                <button type="submit" class="text-red-600 hover:text-red-900 transition duration-300 ease-in-out" onclick="return confirm('¿Estás seguro?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 102 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                            </form>
                        </div>
